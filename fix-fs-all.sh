...
# Find files with dynamic access warnings
# The warnings came from bin/cli/commands/backup.mjs, setup-codex.mjs, open-sse/executors/auggie.ts, chatgpt-web-codex, devin-cli, zcode
FILES=(
